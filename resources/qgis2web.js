...
map.getView().fit([1883182.720499, 5095183.135947, 2827880.293591, 5804807.361889], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Potential Spatial Accessibility to Primary Percutaneous Coronary Intervention (pPCI) Facilities in The Republic of Serbia for the Year 2030</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1471 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This study evaluates the potential spatial accessibility of primary percutaneous coronary intervention (pPCI) facilities in the Republic of Serbia (RS) for the year 2030. Cardiovascular diseases, specifically acute myocardial infarction (AMI), are major contributors to mortality, requiring immediate intervention to reestablish blood circulation to the heart. This research employs travel-time isochrone analysis to assess the percentage of the population residing within three specific time intervals (30, 60, and 90 minutes) from a pPCI facility. We project the percentage of the population residing within a 30- minute travel- time interval to be 50% in 2030. Additionally, the percentage of population residing within the 90- minute travel- time interval from a pPCI facility i.e., known as the “golden hour” travel- time distance is around 96% with some weekly variations which equate to 1%. We utilized additional spatial analysis to identify population clusters that reside beyond the 90-minute driving time from a pPCI facility. This information is critical for highlighting areas that require new pPCI facilities or improved road infrastructure. Additionally, the study highlighted the optimal location for a novel pPCI facility which is the city of Vršac. The study highlights the significance of strategic planning and data-driven decision-making in public health to improve accessibility and decrease mortality rates associated with cardiovascular diseases. ';
            }
